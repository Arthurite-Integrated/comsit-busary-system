...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <div id="content_title_box">
	        <h2>Deduction Definition (Individual)</h2>
                <p>Define monthly deduction for a staff.</p>
        ...
        <form enctype="multipart/form-data" name="frm" id="frm">
		  <table width="70%" border="0">
		    <tr>
		      ...
		      <th width="20%" rowspan="6" align="left" valign="top">_____________________</th>
		      </tr>
		    <tr>
		      <th width="20%" colspan="2" align="left" valign="top">Account Code:<strong style="color:#F00">*</strong><br />
		        <select name="folio" id="folio" style="width:450px" onChange="if($('#fileno').val() != '' && $('#folio').val() != ''){ swapcontent('get_cumulative_per_item', $('#fileno').val(), $('#folio').val() ); }">
		          ...
		          <?php
						  ...
						  $res_c=@mysqli_query($con, "select * from foliotb where not fundcenter in ('01') order by folio_code");
                          while($rs_c=@mysqli_fetch_array($res_c))
                           {
		    ...
		    <tr>
		      <th align="left" valign="top">
		        Cumulative Todate:<br>
<div align="center" id="get_cumulative_per_item" style="width:170px; height:22px; text-align:left; border:solid 1px #999999;"><br />
	            </div>
