     ...
     $('#dgout').datagrid({
          onSelect: function(index, row){
               ...
               if(x < max_fields){
                    ...
                    $(".rw").before('<tr style="font-size:12px"><td><a href="#" class="delete"><strong>X</strong></a></td><td nowrap><input type="search" name="bcode[]"  onBlur="swapcontent(\'foliodesc\', this.value, ' + x + ');" value="' + row.folio_code + '" readonly size="11" maxlength="11"></td><td style="font-size:12px"><div id="foliodesc' + x + '">' + row.title + '<input type="hidden" name="fdesc[]" value="' + row.title + '"></div></td><td width="5%"><input type="number" class="amt2" name="dr_bamt[]" onblur="sum2(\'amt2\')" style="background-color: #FEFFB0;font-weight: bold;text-align: right;"></td><td width="5%"><input type="number" class="amt3" name="cr_bamt[]" onblur="sum2(\'amt3\')" style="background-color: #FEFFB0;font-weight: bold;text-align: right;"></td></tr>');
     ...
     <div id="tooplate_wrapper">
          ...
          <div id="tooplate_main">
                                   ...
                                   <form enctype="multipart/form-data">
                                        <table border="0" cellpadding="0" cellspacing="0" class="vch" style="width:780px">
                                             <tr>
                                                  ...
                                                  ?>
                                                  <th height="50" align="left" bgcolor="#F1F1F1">Financial Year (Date):
                                                  <input type="hidden" name="lockdate" id="lockdate" value="<?=$lockdate; ?>" />
                                                       <br />	            <input type="date" name="pay_date" style="width: 300px" class="date" id="pay_date" min="<?=$lockdate; ?>"  onchange="swapcontent('getJVNo');" value="" /></th></tr>
                                                  ...
                                                  <tr bgcolor="#6BF4C7">
                                                       <th height="50" colspan="3" align="center" valign="middle">JV No:
                                                            <input type="text" name="jv_no" style="width: 300px" class="date" id="jv_no" onchange=""/><span id="getJVNo"></span></th>
                                                       </tr>
                                                       <tr bgcolor="#6BF4C7">
               ...
               <table border="0" cellpadding="0" cellspacing="0" class="vch">
                    <tr>
                         <th height='33'> <input type="checkbox" name="pro_type" value="final" id="pro_type" style="appearance:radio-button; height:30px; width:30px; border:outset 1px red;" checked>
                    </th>
