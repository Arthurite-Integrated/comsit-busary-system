...
if(strtolower($role) == "bursar"){
	header("mail.php?r_val=<?php echo $r_val; ?>&mail_opt=new");
	exit;
}
*/
?>
...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <div id="content_title_box">
	        <h2>Main Menu</h2>
               <p>Select any of the link at the <strong>left-hand</strong> side to continue. </p>
        ...
        <div id="tooplate_content">
        	...
        	<div class="content_box">
               ...
               You are successfully logon to Bursary Automation System.
