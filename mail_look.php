...
<div id="tooplate_wrapper">
        ...
        <div id="tooplate_content">
        	...
        	<div class="content_box">
                ...
                <div class="easyui-tabs" data-options="tabWidth:100,tabHeight:60" style="width:700px;" id="tt">
                    ...
                    <div title="<span class='tt-inner'><img src='images/inmail.png'/><br>Incoming Mail</span>" style="padding:10px">
                    <table id="dg" title="" style="width:680px;" data-options="
                multipleSelect:true,
                url: 'scriptfile_y.php?contentvar=assign_look&dept_unit=<?php echo $role_use;?>',
    ...
    <form id= 'assignmails'  enctype="multipart/form-data" name="assignmails"> 
				...
				<a href="#" class="easyui-linkbutton" iconCls="icon-ok" onClick= "getSelections(); swapcontent('assignmail_look',$('#memoid').val(),$('#login_id').val()); reloadgrid();">Post Mail to Unit CA</a>
