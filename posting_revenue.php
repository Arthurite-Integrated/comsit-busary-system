...
?>
  ...
  <tr>
<td colspan='1' align="left" valign="top"><strong>Date</strong><br /><input type="text" name="transdate" id="transdate" size="25" tabindex="3" class="easyui-datebox"  data-options="formatter:myformatter,parser:myparser"  required="required" />
</td>
</tr>
				<tr>
  ...
  <select name="fileno" id="fileno" tabindex="4" style="width:400px">
    ...
    <?php
				...
				<select name="folio_code" id="folio_code" tabindex="5" style="width:400px">
					<option selected="selected" value="">---</option>
					<?php
					$r=@mysqli_query($con, "select distinct *  from foliotb order by title,folio_code");
					while ($rcourse=@mysqli_fetch_array($r))
						{
			...
			<div class="easyui-tabs" style="width:auto;height:auto"> <!-- begining of main tab -->
			 ...
			 <center>
				...
				<tr><th colspan="2">
				<input type="button" class="btn" name="sbtn" id="sbtn" value="Save" tabindex="9" onclick="swapcontent('posting_section','save','Credit');" />
				<input type="button" class="btn" name="chbtn" id="chsbtn" value="Search" onclick="swapcontent('posting_section','search','Credit');" />
				<input type="button" class="btn" name="chbtn" id="chsbtn" value="View All" onclick="swapcontent('posting_section','view_all','Credit');" />
				<input type="button" class="btn" name="chbtn" id="chsbtn" value="Refresh" onclick="swapcontent('posting_section','refresh','Credit');" />
				<!--,$('#ccode').val()-->
