...
{   //swap content begins where cv means div id name
 ...
 if(cv=='main_login') //start putme_login
  ...
  if(cv=='another') //start putme_login
  {
	...
	if(cv=='annual_increament')
	{
		if($("#year").val()=='')
		 { alert('Select Year from the list'); $('#roll').html('').show(); exit();}
...
<div class="content">
        ...
        <h3><i> Annual Step Increament(s)</i></h3> -->
        <p>
        <form>
		  <table width="70%" border="0">
		    <tr>
		      <th width="50%" align="left" valign="top">Staff Category<br />
				<select style="width:150px" name="staff" id="staff" tabindex="3" onchange="swapcontent('specific',this.value)">
		      ...
		      <th width="50%" align="left" valign="top">Year<br />
		        <select name="year" id="year" class="txt" style="width:150px">
		    ...
		    <tr>
		      <th colspan="2"><input type="button" name="Button" id="button" value="Update Record" class="btn" onclick="swapcontent('annual_increament');"/></th>
	        </tr>
	      </table>
        <div id="display"></div>
         <div id="display2"></div>
