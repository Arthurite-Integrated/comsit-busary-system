...
{   //swap content begins where cv means div id name
 ...
 if(cv=='loan_section_entry') //start putme_login
  {
			...
			$('#roll').html('').show();
                              swapcontent('generate_pvno', $("#pay_date").val());
...
<body class="subpage" onLoad="swapcontent('load_voucher_fileno', 'InternalLoan'); $('#ptin_row').hide(); ">
    ...
    <div id="tooplate_main">
        ...
        <div id="tooplate_content">
		  ...
		  <table border="0" cellpadding="0" cellspacing="0" class="vch" width="100%">
		    ...
		    <tr>
		      <th height="50" align="left" bgcolor="#F1F1F1" >Year:<br><input name="lyear" type="number" style="width: 300px" id="lyear" size="25" />
              </th>
...
<select name="folio[]" id="folio" class="txt easyui-combogrid" data-options="panelWidth: 600,
  ...
  <select name="bank" id="bank" style="width:300px">
					...
					while ($rcourse=@mysqli_fetch_array($r))
						{
							$scourse=@$rcourse['bankname'];
                                                                      $pcode=@$rcourse['bankname'];
		      ...
		      <th height="50" align="left" valign="middle" bgcolor="#F1F1F1">Amount:<br>
                              <input name="principal" type="number" id="principal" size="25" style="width:300px"/>
		 ...
		 <table width="100%">
				<tr>
				  <th><br><input type="button" class="btn" name="sbtn" id="sbtn" value="Save" onclick="swapcontent('loan_section_entry', 'save'); " /> | 

				<input type="button" class="btn" name="chbtn" id="chsbtn" value="Refresh" onclick="swapcontent('loan_section_entry', 'refresh');" /></th>
				      </th>
			    </tr>
</table> 
