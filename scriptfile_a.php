     ...
     if($action=='save')
     {
          ...
          if(mysqli_query($con, $queryString)){
               if( count($folio)==1 ){
                    ...
                    exit;if(mysqli_query($con, $queryStringA) && mysqli_query($con, $queryStringB) && mysqli_query($con, $queryStringC)){
                         $flag=true;
                    } else {
                         $flag=false;
                         goto TestArea;
