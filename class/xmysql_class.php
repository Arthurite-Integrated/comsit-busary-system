...
class Database{
	...
	private $db_pass = "mypass1";  // Change as required
   // private $db_user = "user";  // Change as required
	//private $db_pass = "passwrord";  // Change as required
	private $db_name = "uilkashdb";	// Change as required
	...
	public function sql($sql){
		...
		if($query){
			...
			$this->other=$this->numResults = mysqli_num_rows($query, 3);
