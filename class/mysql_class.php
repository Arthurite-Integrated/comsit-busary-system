...
class Database{
	...
	public function connect(){
		if(!$this->con){
			//$this->myconn = @mysqli_connect($this->db_host,$this->db_user,$this->db_pass);  // mysqli_connect() with variables defined at the start of Database class
			$this->myconn = @mysqli_connect($this->db_host,$this->db_user,$this->db_pass, $this->db_name);  // mysqli_connect() with variables defined at the start of Database class
            if($this->myconn){
            	/*$seldb = @mysqli_select_db($this->db_name,$this->myconn); // Credentials have been pass through mysqli_connect() now select the database
                if($seldb){
                	$this->con = true;
