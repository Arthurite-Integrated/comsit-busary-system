...
<tr><td align="center" colspan="8"><b> UNIVERSITY OF ILORIN <br> CENTRAL STORES <br> ILORIN <br> GOODS RECEIVED NOTE</b></td></tr>
<tr><td  colspan="8"><b>STORE/SERVICE POINT:</b> <?php echo $loc;?></td></tr>
<tr><td  colspan="8"><b>SUPPLY NAME : </b><?php echo $supps['sup_name'];?></td></tr>
<tr><td  colspan="8"><b>ADDRESS: </b> <?php echo $supps['sup_address'];?></td></tr>
<tr><td  colspan="3"><b>Date :</b><?php echo @date('d/m/Y',strtotime($rs_v['entry_date']));?></td><td colspan="3"> <b>GRN:</b> <?php echo $grn;?></td><td colspan="2"><b>SIV:</b><?php echo $siv;?></td></tr>
          <tr>
            ...
            <td ><div align="center"><strong>Bin/Ledger No</strong></div></td>
            <td ><div align="center"><strong>Order No</strong></div></td>
            <td ><div align="center"><strong>Rate</strong></div></td>
            <td width="20%"><div align="center"><strong>Amount</strong></div></td>
          </tr>
           <?php $grn=@$rs_v['grn'];
		        $res_tax=@mysqli_query($con, "select * from assettb where grn='$grn' order by identify_string");
