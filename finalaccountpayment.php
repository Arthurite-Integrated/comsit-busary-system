...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <div id="content_title_box">
	        <h2><i>Payment Voucher Entry</i></h2>
                <p>Use this form to post payment voucher entry</p>
        </div><!-- end of content_title_box -->
   
        <div id="tooplate_content">
	        
        	<div class="content_box">
              <div class="easyui-panel" title="Payment Voucher Entry" style="width:800px">     
		  ...
		  <table border="0" cellpadding="0" cellspacing="0" class="vch">
		    ...
		    <tr>
		      <th height="50" align="left" bgcolor="#F1F1F1" ><div align="left">Account to be Credited:<br />
            ...
            <tr>
		      <th height="50" align="left" bgcolor="#F1F1F1" ><div align="left">P.V. No.:<br />
                <input name="pvno" type="text" style="width: 300px" id="pvno" size="25" />
		      </div></th>
		      <th height="50" align="right" valign="middle" bgcolor="#F1F1F1" >&nbsp;</th>
