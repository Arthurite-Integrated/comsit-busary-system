        ...
        <div id="tooplate_content">
		  ...
		  <table border="0" cellpadding="0" cellspacing="0" class="vch">
            ...
            <input type='hidden' id='lsn' name='lsn' value='0'>
			  ...
			  <th height="50" bgcolor="#F1F1F1"></th>
			  <td height="50" align="left" bgcolor="#F1F1F1"><div id="get_pv_detail_journal"></div></td></tr>
...
<select name="folio[]" id="folio" class="txt easyui-combogrid" data-options="panelWidth: 600,
			...
			onChange:function(){swapcontent('folio_code_breakdown_journal',this.value);$('#vamount').val('');$('#total').html('');
		$('#total_deduction').html('');$('.class_tax').html('');}" style="width:620px;height:20px" >
  <!-- onblur="swapcontent('folio_code_breakdown_journal',this.value)" onchange="swapcontent('folio_code_breakdown_journal',this.value);swapcontent('load_budget');">
			
			onSelect:function(){swapcontent('folio_code_breakdown_journal',this.value);$('#vamount').val('');$('#total').html('');
		$('#total_deduction').html('');$('.class_tax').html('');},
			 onUnselect:function(){swapcontent('folio_code_breakdown_journal',this.value);$('#vamount').val('');$('#total').html('');
		$('#total_deduction').html('');$('.class_tax').html('');}
		  ...
		  <br />
		 <div id="folio_code_breakdown_journal" style='width:700px;' class='easyui-panel' title='Folio / Code Breakdown'></div> 
         <br>
         ...
         <!--<table border="0" cellpadding="0" cellspacing="0" class="vch">
            <tr>
		      <th height="50" align="left" bgcolor="#F1F1F1" ><div id="div">
		        <label for="pvno"><strong>PV. No.:</strong><br>
		          <input type="text" id="pvno" name="pvno" style="width: 300px">
		          </label>
		         </div></th>
		      <th height="50" align="right" valign="middle" bgcolor="#F1F1F1" >&nbsp;</th>
		      <th height="50" align="left" valign="middle" bgcolor="#F1F1F1" ><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" onclick="swapcontent('get_pv_detail_journal');"><strong><font color="#000099">GET PV</font></strong></a></th>
	        </tr>
            <tr>
            	<td height="50" colspan="3" align="center" valign="middle">
                	<div id="get_pv_detail_journal"></div>
            	</td>
            </tr>
		</table>-->
        <div id="display"></div>
