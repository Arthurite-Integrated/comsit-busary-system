...
<div class="content">
                ...
                <div class="easyui-tabs" style="width:auto;height:auto" id="tt"> <!-- begining of main tab-->
                  <div title="GRN Generation" style="padding:10px">  <!-- pending tab  -->
        <!--<h3><i>Budget</i></h3>
		  <p>
          </p>-->
          <form action="fixed_asset.php" method="post" enctype="multipart/form-data" name="frma"  id="frma" target="_blank">
			<table width="70%" border="0">
			  <tr>
			    <th align="left" valign="middle" height="33">Select GRN</th>
			    <td height="33" align="left" valign="middle"><select name="grn" id="grn" style="width:200px">
			      <option selected="selected" value="nil">Select item...</option>
                  <option  value="new">Generate New GRN</option>
			      <?php
                          $res_c=@mysqli_query($con, "select * from grn_sivtb where checked_by = 'No' order by grn");
                          while($rs_c=@mysqli_fetch_array($res_c))
                           {
                              $grn=$rs_c['grn'];
							  $siv=$rs_c['siv'];
							  //$grn_siv=$rs_c['grn']."****".$rs_c['siv'];
			  ...
			  <tr>
			    <th colspan="2" align="left" valign="middle" height="33"><div align="center">
			      <input type="submit"  class="btn" name="btn" id="btn"  value="Continue" />
			      ...
			      <input type="submit"  class="btn" name="btn2" id="btn2"  value="Generate New GRN" />-->
			    </div></th>
			    </tr>
	    </table>
