...
<head>
	...
	<link rel="stylesheet" type="text/css" href="include/new_iu/easyui.css">
	<link rel="stylesheet" type="text/css" href="include/new_iu/icon.css">
	<link rel="stylesheet" type="text/css" href="include/new_iu/demo.css">
	<script type="text/javascript" src="include/new_iu/jquery.min.js"></script>
	<script type="text/javascript" src="include/new_iu/jquery.easyui.min.js"></script>
</head>
<body>
