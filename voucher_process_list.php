                       ...
                       <div title="Pending" style="padding:10px">  <!-- pending tab  -->
                         <?php
						  ...
						  //echo $sql="select * from vouchertb where dept_code='".$_SESSION['userunit']."' and prepared_by = '".$login_id."' and checked_by ='' order by voucher_date desc";exit;
						   ...
						   elseif($r=="super admin"  or $r=="administrator" or $r=="prepared officer")
						       $sql="select * from vouchertb where dept_code='".$_SESSION['userunit']."' and prepared_by = '".$login_id."' and checked_by ='' order by voucher_date desc";
