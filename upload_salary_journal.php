      ...
      <table width="80%" >
        ...
        <tr>
          <td colspan="4" align="center"><div align="center">
             <input name="mode" type="hidden" id="mode" value="upload" /> <input name="button" type="submit" class="btn" id="button" value="Upload Journal" />
            </div>
  ...
  <?php
		   ...
		   if(isset($_REQUEST['mode']) and $_REQUEST['mode']=='upload')
		   {
			...
			$login_id=@$_SESSION['login_id'];
			   ...
			   $thead="<table><tr><th>S/NO</th><th>DATE</th><th>PAYMENT NUMBER</th><th>ACCOUNT CODE</th><th>AMOUNT</th><th>TYPE</th></tr>";
