...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <div id="content_title_box">
	        <h2>COMPARE CASHBOOK ENTRIES</h2>
...
<!-- begining of main tab-->
  ...
  <?php
     if(isset($_POST['mode']) && $_POST['mode']=='upload'){
		...
		$sn=0;
		echo "<center><h1>{$from}/{$to} COMPARE</h1></center>
          <table align='left' border='1' cellpadding='5' cellspacing='0' rules='rows' frame='box' width='100%' class='displayX' id='dTableX'> 
		<thead>
          <tr><th colspan='3'>MANUAL</th><td style='background-color: black;'>&nbsp;</td><th colspan='3'>AUTOMATED</th></tr>
