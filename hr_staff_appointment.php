...
<div class="content">
                ...
                <h3><i>Staff Appointment</i></h3>
			    <p>
				
			<form name="frm" id="frm">
            	<table>
				<tr>
				  <th colspan="2"> <div align="center"><font color="red">Application Year: </font>
				...
				<th><div align="center">Position/Rank</div></th>  
				</tr>
				<tr>
				...
				<tr>
				  <th colspan="2"><!--<input type="button" class="btn" name="sbtn" id="sbtn" value="Save"   />-->
                  <input type="button" class="btn" name="chbtn" id="chsbtn" value="Display" onclick="swapcontent('display_applicant');"  /></th>
				  </tr>
				</table>
