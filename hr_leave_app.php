...
<div class="content">
                ...
                <h3><i>Leave Application </i></h3>
			    <p>
			<form name="leave_app_frm" id="leave_app_frm">
            	<table>
				<tr>
				...
				<tr>
				<th><div align="left">Leave Type</div></th>  
					<td><select name="leave_type" id="leave_type" >
                  		<option selected="selected" value="">--</option>
                  		<?php 
				 			$sql= @mysqli_query ("select * from hr_leavetb");
				  				while ($sqlrs= @mysqli_fetch_array ($sql))
				  					{
				  						$leave_type=@$sqlrs['leave_type'];
										 echo "<option value='$leave_type'>$leave_type</option>";
									}
                 			?>
				 
						</select></td>
				<th><div align="left">Application Date</div></th> <td><input type="text" name="app_date" id="app_date"/></td>
				<tr>
				<th><div align="left">Proposed Start Date </div></th><td><input type="text" name="app_start_date" id="app_start_date" /></td>
				<th><div align="left">Proposed End Date </div></th><td><input type="text" name="app_end_date" id="app_end_date" /></td>
				</tr>
				...
				<tr>
				  <th colspan="4"><input type="button" class="btn" name="sbtn" id="sbtn" value="Save" onclick="swapcontent('leave_app_section','save');" />
			       <input type="button" class="btn" name="chbtn2" id="chbtn" value="View All" onclick="swapcontent('leave_app_section','view_all');" />
