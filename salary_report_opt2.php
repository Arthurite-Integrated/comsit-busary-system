...
<div class="content">
			...
			<p>
			<form action="salary_report.php" method="post" enctype="multipart/form-data" name="dept_frm" id="dept_frm" target="_blank">
...
<select name="year" id="year" tabindex="4" style="width:200px">
              ...
              <tr>
			   ...
			   <tr><th colspan="2">
			   			Folio Code<br />
				<select name="folio_code" id="folio_code" tabindex="8" style="width:450px">
					<option selected="selected" value="">---</option>
					<?php
	...
	<input type='radio' name='v_opt' id='v_opt2' tabindex="10" value='allowance_summary'>Allowance Summary Per Staff</input><br />
  	
	
	
	
		<input type='radio' name='v_opt' id='v_opt7' tabindex="15" value='annual_gross_summary'>Annual Gross Pay Summary</input><br />
		<input type='radio' name='v_opt' id='v_opt8' tabindex="16" value='annual_deduction_summary'>Annual Deduction Summary</input><br />
		<input type='radio' name='v_opt' id='v_opt6' tabindex="14" value='folio_summary'>Allowance / Deduction  Summary Per Folio</input><br />
		<input type='radio' name='v_opt' id='v_opt5' tabindex="13" value='deduction_summary_dept'>Deduction Summary Per Department</input><br />
		<input type='radio' name='v_opt' id='v_opt3' tabindex="11" value='deduction_summary'>Deduction Summary Per Staff</input><br />
	<input type='radio' name='v_opt' id='v_opt4' tabindex="12" value='gross_summary'>Gross Pay Summary Per Department</input><br />
		<input type='radio' name='v_opt' id='v_opt1' tabindex="9" value='net_pay_summary' checked>Net Pay  Summary Per Staff</input><br />
		
		
		<input type='radio' name='v_opt' id='v_opt9' tabindex="9" value='individual_prc' checked>Individual Pay Record Card</input><br />
		<input type='radio' name='v_opt' id='v_opt9' tabindex="9" value='group_prc' checked>Group Pay Record Card</input><br />
										 </td>
				</tr></table>
				  </center>
				</th>
