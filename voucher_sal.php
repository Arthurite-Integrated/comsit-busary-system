...
{   //swap content begins where cv means div id name
 ...
 if(cv=='login') //start putme_login
  ...
  if(cv=='load_voucher_details_salary') //start unit
  {
	  //alert(cv+" "+v+" "+a);exit();
	  //alert($("form").serialize());exit();
	  //var pay_date=$("#pay_date").val();
 ...
 if(cv=='voucher_section_salary') //start putme_login
  {
    ...
    <div id="tooplate_main">
        ...
        <div id="tooplate_content">
		  ...
		  <table border="0" cellpadding="0" cellspacing="0" class="vch">
		    <tr>
		      <td colspan="3"><div align="righdt"><input type="button" class="easyui-linkbutton" name="chbtn1" id="chsbtn1" value="My Entries" onclick="swapcontent('voucher_section_salary','view');" /> 
...
<select name="type" id="type" class="txt" onchange="swapcontent('load_voucher_fileno',this.value);swapcontent('load_voucher_details_salary',this.value); if($('#type option:selected').val() == 'Internal'){ $('#ptin_row').hide(); }else{ $('#ptin_row').show(); } " style="width: 300px">
		        <option selected="selected" value="">---</option>
