...
<div class="content">
                ...
                <h3><i>Password Management</i></h3>
			    <p>
			 <div id='password_mgt'></div><center><table>
			      <tr><th>Login ID</th><td><b><?php echo strtoupper($login_id); ?></b></td></tr>
				  <tr><th>Old Password</th><td><input type='password' name='oldpwd' id='oldpwd'/></input></td></tr>
				  ...
				  <tr><td colspan='2'><center><input type='button' class='btn' value='Change' onClick="swapcontent('password_mgt');"/></center></td></tr>
				  </table></center>
