...
//	and asset_category='$cat_code' and asset_type='$asset_code' ";
 ...
 $tb.="<tr><th>ASSET NUMBER</th><th>Cost As At </th><th>Additions During Year</th><th>Total Cost As At</th><th>Agg.Depn As At</th><th>Depn.for the year</th><th>Agg.Depn. As At.</th><th>NBV</th></tr>";
...
$tb.="<tr><td>$dentify_string</td><td><b>N".@number_format($total1,2)."</b></td><td>0.00</td><td><b>N".@number_format($total1,2)."</b></td><td><b>N".@number_format($total2,2)."</b></td><td><b>N".@number_format($total3,2)."</b></td><td><b>N".@number_format($total5,2)."</b></td><td><b>N".@number_format($total4,2)."</b></td></tr>";
		  $tb.="</table>";
		  echo $tb;
	} 
