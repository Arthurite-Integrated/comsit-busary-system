...
{   //swap content begins where cv means div id name
 ...
 if(cv=='bankdetails') //start
  {
			if(v=='save_l')
			 {
				 if($("#fileno").val()=='' || $("#start_date").val()=='' || $("#pstatus").val()=='' || isNaN($("#amount").val()) || $("#amount").val() <= 0)
				 {
			...
			if(v=='save_b')
			 {
				 if($("#fileno").val()=='' || $("#bank").val()=='' || $("#acct").val()=='')
				 {
					 alert($("#frm").serialize()); exit;
					 alert("All compulsory fields must be filled before you can proceed.");
					 $('#roll').html('').show();
			...
			$(divid).html('').show();	
			i//f(v=='view') $('#bankdetails_v').html(data).show();else 
			...
			if(v=='save' || v=='delete')
			    {
					  //swapcontent('bankdetails','refresh');
					$("#fileno").val('');
					//$("#type").val('');
					$("#start_date").val('');
					$("#end_date").val('');
...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <div id="content_title_box">
	        <h2><?php echo base64_decode($_REQUEST['pagetitle']); ?></h2>
                <p>Update Bank/Loan Record.</p>
		  ...
		  <table width="70%" border="0">
		    <tr>
		      <th colspan="2" align="left" valign="top">File Number:<strong style="color:#F00">*</strong><br />
		        <select name="fileno" id="fileno" style="width:450px" onChange="if($('#fileno').val() != ''){ swapcontent('bankdetails','view'); } ">
		      ...
		      <th width="20%" rowspan="8" align="left" valign="top"><p>&nbsp;</p></th>
		      </tr>
              <?php if($_REQUEST['r']==1){ ?>
		    <tr>
		      <th colspan="2" align="left" valign="top">Amount:<strong style="color:#F00">*</strong><br />
		        <div id="bankdetails_v">
		          <input name="amount" type="text" id="amount" size="25" style="width:220px"/>
		        </div></th>
		      </tr>
		    <tr>
		    ...
		    <tr>
		      <th colspan="2" align="left" valign="top">Remark:<br>
		    ...
		    <tr>
		      ...
		      <th align="left" valign="middle" nowrap="nowrap"><input type="button" name="savebutton" id="savebutton" value="Save/Update" class="btn" onClick="swapcontent('bankdetails','save_l','');"/>
		        <input type="button" name="button5" id="button5" value="View All" class="btn" onClick="swapcontent('bankdetails','view');"/>
		        <input type="button" name="button3" id="button3" value="Refresh" class="btn" onClick="swapcontent('bankdetails','refresh','');"/></th>
		      </tr><?php }elseif($_REQUEST['r']==2){ ?>
		    <tr>
		      <th align="left" valign="top">Bank Name:<strong style="color:#F00">*</strong><br /><input name="bank" type="text" id="bank" size="25" style="width:220px"/>                </th>
		      <th align="left" valign="middle" nowrap="nowrap">&nbsp;</th>
		      </tr>
		    <tr>
		      <th align="left" valign="top">Account Number:<strong style="color:#F00">*</strong><br /><input name="acct" type="text" id="acct" size="25" style="width:220px"/>                </th>
		      <th align="left" valign="middle" nowrap="nowrap">&nbsp;</th>
		      </tr>
		    <tr>
		      <th align="left" valign="top">&nbsp;</th>
		      <th align="left" valign="middle" nowrap="nowrap"><input type="button" name="savebutton" id="savebutton" value="Save/Update" class="btn" onClick="swapcontent('bankdetails','save_b','');"/>
		        <input type="button" name="button5" id="button5" value="View All" class="btn" onClick="swapcontent('bankdetails','view');"/>
		        <input type="button" name="button3" id="button3" value="Refresh" class="btn" onClick="swapcontent('bankdetails','refresh','');"/></th>
		      </tr><?php } ?>
		    <tr>
