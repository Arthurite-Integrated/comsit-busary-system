...
<div class="content">
        ...
        <!--<h3><i>Budget</i></h3>
          ...
          <form action="store_report_pro.php" method="post" enctype="multipart/form-data" name="frma" target="_blank" id="frma">
			<table width="70%" border="0">
			  ...
			  <tr>
			    ...
			    <td ><select name="type" id="type" style="width:150px" class="txt">
			      <option value="hi" selected="selected">Select</option>
			      <option value="Yes">Fixed Asset</option>
			      <option value="No">Consumables</option>
			        
	        </select></td> <th align="left" valign="middle" height="33">Location</th><td><select name="location" id="location" style="width:200px" class="txt easyui-combobox">
			  ...
			  <tr>
                ...
                <input type="submit"  class="btn" name="btn" id="btn"  value="Find Asset" />
