...
<div class="content">
        ...
        <!--<h3><i>Budget</i></h3>
          ...
          <form action="stock_card_pro.php" method="post" enctype="multipart/form-data" name="frma" target="_blank" id="frma">
			<table width="70%" border="0">
			  <tr>
			    <th align="left" valign="middle" height="33">Product Name:</th>
			    <td height="33" align="left" valign="middle"><select name="prod_id" id="prod_id" style="width:200px" required="required">
			  ...
			  <tr>
			    <th colspan="2" align="left" valign="middle" height="33"><div align="center">
			      <input type="submit"  class="btn" name="btn" id="btn"  value="Generate Stock Card" />
