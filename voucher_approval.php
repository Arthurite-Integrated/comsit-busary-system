...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <div id="content_title_box">
	        <h2>Approve Scheduled Vouchers</h2>
                <p>...</p>
...
<div id="page-wrapper">
	...
	<div id="page" class="container">
	  <div class="content">
       ...
       <h3><i>Approve Scheduled Vouchers</i>        </h3> -->
        <center> 
        <form enctype="multipart/form-data">
		  <table border="0">
		    <tr>
		      <th>Schedule Number
              <br />
              <input name="sch_no" type="text" id="sch_no" size="40" /></th>
	        </tr>
		    <tr>
		      <th><input type="button" name="button" id="button" value="Display Scheduled Vouchers" class="btn" onclick="swapcontent('display_approve_schedule_voucher','search');"/></th>
	        </tr>
          </table>
        <div id="display"></div>
         <div id="display2"></div>
