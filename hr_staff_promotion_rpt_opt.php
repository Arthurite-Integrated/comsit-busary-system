...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
      ...
      <h3><i>Staff Promotion Report </i></h3>
                
			  <p>
            			This section is used to view staff promotion report. Kindly supply correct information in the spaces provided and ensure that you cross-check all your entries before submission. <br/>
            			<br/>
      <form name="frmbio" id="frmbio" action="hr_staff_promotion_report.php" target="_blank">            
          <table  border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
						  ...
						  <span id='promotion_basic_info'></span>
                             <input type="submit" name="button" id="button" value="Display Report" class="btn" onClick="swapcontent('promotion_display_report',$('#fileno').val(),$('#app_year').val())"/> 
