...
<div class="content">
        ...
        <!--<h3><i>Budget</i></h3>
          ...
          <form action="report1.php" method="post" enctype="multipart/form-data" name="frma" target="_blank" id="frma">
			<table width="70%" border="0">
			  ...
			  <tr>
			    <th align="left" valign="middle" height="33">Select Year:</th>
			    <td ><select name="year" id="year" style="width:150px" class="txt">
			        <?php 
				  $dSess = @date('Y');
				...
				?>
			        </select></td> <th align="left" valign="middle" height="33">Location</th><td><select name="location" id="location" style="width:200px" >
                                <option selected="selected" value="">Select item...</option>
                                <?php
                          $res_c=@mysqli_query($con, "select * from locationtb order by dept");
                          while($rs_c=@mysqli_fetch_array($res_c))
                           {
                              $dept=@$rs_c['dept'];
							  $unit=@$rs_c['unit'];
							  $loc_code=@$rs_c['loc_code'];
                              echo "<option value='$loc_code'>$dept <=> $unit</option>";
                           }
                          echo "</select>";
						 ?>
                              </select></td>
			  ...
			  <tr>
			    <th align="left" valign="middle" height="33">
                Category 
                </th> <td><select name="cat_type" id="cat_type" style="width:200px"  onchange="swapcontent('catdiv', $('#cat_type').val());">
                  <option selected="selected" value="">Select item...</option>
                  <?php
                ...
                Type 
                              ...
                              <select name="asset_cat" id="asset_cat" style="width:200px" >
                                <option selected="selected" value="">Select item...</option>
                                <?php
                          $res_c=@mysqli_query($con, "select * from asset_typetb order by type_title");
                          while($rs_c=@mysqli_fetch_array($res_c))
                           {
                              $type_title=@$rs_c['type_title'];
							  $type_id=@$rs_c['type_id'];
							  $asset_code=@$rs_c['asset_code'];
			  ...
			  <tr>
			    <th align="left" valign="middle" height="33">Disposabe</th>
			    <th align="left" valign="middle" height="33"><label for="dispose"></label>
			      <select name="dispose" id="dispose" >
			        <option value="">Select Item...</option>
			        <option value="No">No</option>
			        <option value="Yes">Yes</option>
			        </select></th>
			    <th align="left" valign="middle" height="33">&nbsp;</th>
			    <th align="left" valign="middle" height="33">&nbsp;</th>
			    </tr>
			  <tr>
			    <th colspan="4" align="left" valign="middle" height="33"><div align="center">
                <input type="submit"  class="btn" name="btn" id="btn"  value="Find Assets" />
