...
if(!isset($_SESSION['userLogin']) and !isset($_SESSION['login_id']) and !isset($_SESSION['login_status']) and !isset($_SESSION['role']) and $_SESSION['userLogin']!='ok')
   {
    ...
    $r_vals=@base64_decode($_REQUEST['r_val']); $rv=$_REQUEST['rv'];
$role=@$_SESSION['role'];
    ...
    <script>
		...
		{   //swap content begins where cv means div id name
            ...
            parent.location.reload();
						//window.close(); //.location='voucher_process.php'; //.reload();
						//$('#cboxClose').click();
...
Voucher Item</th>
	...
	<h3>VOUCHER PROCESSING</h3><hr><form name='frmpro' id='frmpro'>
	  	<table width='70%' align='center'>
			 <tr><th align='left'>PAYMENT DATE: </th><td><input type='date' name='pay_date' id='pay_date' style='width: 300px' /></td></tr>
			 <tr><th align='left'>FUNDING ACCOUNT: </th><td>
			 <select name="acctcode" id="acctcode" class="txt" style="width: 300px" onchange="Xswapcontent('generatePVNo', $('#acctcode').val(), $('#pay_date').val())" >
								...
								while ($rcourse=@mysqli_fetch_array($r))
									{
										...
										echo "<option value='$pcode'>$scourse <=> ($pcode)</option>";  //$bank || $acctno || 
									} ?>
                </select>
				<input type='hidden' name='r_vals' id='r_vals' value='<?php echo $rv; ?>'/>
				<input type='hidden' name='pvno' id='pvno' value='<?php echo $pvno; ?>'/></td></tr>
<?php
			 ...
			 $pvno_paid = $rs_v['pre_pvno']; ///$prefix.$pf.str_pad(($bursary->get_any_value("count(*) as cnum", "vouchertb", "acctcode", $rs_d['acctcode'], " and pvno_paid != ''") + 1), '3', '0', STR_PAD_LEFT);
			  ?>
			 <tr><th align='left'>P.V. NO.: </th><td><!--input type='hidden' name='acctcode' id='acctcode' value='".$rs_d['acctcode']."'-->
			 <div id='generatePVNo'><input type='text' name='pvno_paid' id='pvno_paid' style='width: 300px' value='<?php echo $pvno_paid; ?>'/></div></td></tr>

			 <tr><th align="left">BATCH NO:</th><td><input type='text' name='cheque_no' id='cheque_no' style='width:300px'/></td></tr>
			 ...
			 <tr><th align='left'>ACTION</th><td><select name='opt' id='opt' style='width:300px'>
				<option selected value=''>---</option>
				<option value='Approved'>Processed</option>
				<!--option value='Not Approved'>Not Approved</option-->
				<option value='Queried'>Queried</option>
			 </select></td></tr>
			 <tr><th></th><td colspan='2' align='left'><input type='button' name='cmdpro' id='cmdpro' value='Process for Payment' onclick="swapcontent('process_voucher');" class='btn'/></td></tr>
			</table><br><div id='process_voucher'></div></form>
