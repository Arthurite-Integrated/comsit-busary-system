...
<div class="content">
        ...
        <!--<h3><i>Budget</i></h3>
          ...
          <form action="fix_report_all_pro.php" method="post" enctype="multipart/form-data" name="frma" target="_blank" id="frma">
			<table width="70%" border="0">
			  ...
			  <tr>
				...
				?>
			        </select></td> <th align="left" valign="middle" height="33">&nbsp;</th><td>&nbsp;</td>
		      </tr>
			  <!--<tr>
