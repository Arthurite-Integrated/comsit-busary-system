...
<div class="content">
        ...
        <div id="roll"></div>
             ...
             <tr>
               <td align="center" bgcolor="#D6D6D6"><strong>REVENUE BUDGET PERFORMANCE</strong></td>
             ...
             <tr>
               <td align="center" bgcolor="#D6D6D6"><form name="frm" id="frm4" action="revenue_performance_2.php" target="_blank" method="post">
                 <table width="70%" border="0">
                   <tr>
                     <td width="" align="left"><strong>Year</strong> <br />
              ...
              <td align="center" bgcolor="#E5E5E5"><form name="frm" id="frm4" action="revenue_performance_nuc2.php" target="_blank" method="post">
			   ...
			   <tr>
               <td align="center" bgcolor="#D6D6D6"><strong>FINAL ACCOUNT REPORT</strong></td>
               <td align="center" bgcolor="#D6D6D6"><strong>FINAL ACCOUNT REPORT2</strong></td>
             </tr>
             <tr>
               <td align="center" bgcolor="#D6D6D6"><form name="frm" id="frm4" action="revenue_performance4.php" target="_blank" method="post">
                 <table width="70%" border="0">
                   <tr>
                     <td width="" align="left"><strong>Year</strong> <br />
                       <select name="pyear4" id="pyear4" style="width:90%">
                         <option selected="selected" value="">---</option>
                         <?php
                          for($i=date('Y');$i>=2015; $i--)
                           {
                   ...
                   <tr>
                     <th height="68" colspan="2"><input type="submit" name="button" id="button2" value="Display Final Acount Report" class="btn"/></th>
                   </tr>
                 </table>
                 <div id="display7"></div>
                 <div id="display8"></div>
              ...
              <td align="center" bgcolor="#E5E5E5"><form name="frm" id="frm4" action="revenue_performance5.php" target="_blank" method="post">
                <table width="70%" border="0">
                   <tr>
                     <td width="" align="left">Year <br />
                       <select name="pyear4x" id="pyear4x" style="width:90%">
                         <option selected="selected" value="">---</option>
                         <?php
                          for($i=date('Y');$i>=2015; $i--)
                           {
                  ...
                  <!-- <tr>
                   ...
                   <tr>
                     <th colspan="2"><input type="submit" name="button2" id="button3" value="Display Final Acount Report" class="btn"/></th>
                   </tr>
                 </table>
                 <div id="display9"></div>
                 <div id="display10"></div>
