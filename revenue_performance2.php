...
//////////////////////////////////////////////////////Report Body /////////////////////////////////////////////
?>
<?php echo "<center><img src='$val[1]' width='50' height='50' style='float:center'/><!--<img src='images/uith.png' width='50' height='50' style='float:right'/>--></center><b><p align='center'><u>".strtoupper($val[0])."<br/>"."REVENUE REPORT(INCOME):   ".$from. " TO ". $to ."</u></p></b><hr><p>";
  ?>
                                                                                                                                                                                                                                                                              <center>
 ...
 <?php
	...
	$total_b = 0; 		$total_s = 0;	$total_sx = 0;	$total_v = 0;
	while($yq =  mysqli_fetch_array($bcat, 3 )){
	  echo "<tr bgcolor='#999'>";
	  echo "<th> </th>
			<th colspan='3' align='left'>".$yq[0]."</th></tr>";
	 $sn=0;	
	 $sub_total_b = 0; 	$sub_total_s = 0; $sub_total_sx = 0;	$sub_total_v = 0;
	 ...
	 // $sub_total_b += $folio_budget;			$total_b += $sub_total_b;
	  ...
	  $sub_total_s += $folio_budget_generate;	$sub_total_sx += $folio_budget_generate;	
