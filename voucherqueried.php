...
<tbody> <?php
          ...
          while($rs_v=mysqli_fetch_array($res_v))
          {
                    ...
                    <tr>
                              <td><?=$sn; ?></td>
                              <td style='font-size:10px;'><?=$desc3;?></td>
                              <!--td>$pvno_paid</td-->
                              <td><?=$payee_name;?></td>
               ...
               <?php
                    ...
                    { 
                         ?>
                     | <a class='iframe' href='#' id='myBtn' onclick="var modal = document.getElementById('myModal'); var btn = document.getElementById('myBtn');
               sendRequest('viewVoucherResubmit', 'voucherProcess', '<?=$p;?>', '<?=$r;?>'); modal.style.display = 'block'; " >RE-SUBMIT</a>
                      <?php 
                     }
                    else 
                    {
