...
<div class="content">
                ...
                <h3><i>Manpower Budgeting </i></h3>
			    <p>
				
			<form name="manpowerbudget_frm" id="manpowerbudget_frm" >
            	<table>
				...
				<tr>
				<th><select name="dept_code" id="dept_code" onchange="swapcontent('load_unit',document.getElementById('dept_code').value)">
				...
				<tr>
				<th colspan="2"><div align="center">Position / Post</div>				  <div align="center"></div></th>  
				</tr>
				<tr>
				  <th colspan="2"><select name="position" id="position">
                    <option selected="selected" value="">---</option>
                    <?php
				...
				<tr>
				  ...
				  <th><input type="text" name="no_available" /></th>
				  </tr>
				
				<tr>
				  <th colspan="2">
				  <input type="button" class="btn" name="sbtn" id="sbtn" value="Save" onclick="swapcontent('manpowerbudget_section','save');"/>
				 
                  <input type="button" class="btn" name="chbtn" id="chsbtn" value="View All" onclick="swapcontent('manpowerbudget_section','view_all');"  /></th>
				  </tr>
				</table>
