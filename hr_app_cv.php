...
<table width="641" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td width="361"><strong>Application Number:
      <?php  echo $id; ?>
    </strong></td>
    ...
    <td colspan="3" ><fieldset>
      ...
      <table width="642" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td height="30">&nbsp;</td>
          <td height="30" colspan="2"><?php  echo get_child_no($fileno,'appno','hr_app_childtb') ; ?></td>
        </tr>
        
        <tr>
          <td height="30" colspan="5">
            <fieldset><legend>Position(s) Applied for</legend>
            <table width="637" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><strong>&nbsp;</strong></td>
                <td><strong>Department</strong></td>
                <td width="199"><strong>Position</strong></td>
              </tr>
<?php						
$res_rec_c=@mysqli_query($con, "select * from hr_app_positiontb where appno='$id' order by dept_code");
...
?>
              ...
              <tr>
                ...
                <td width="192"><?php echo @get_dept_name($rs_rec_c['dept_code']);?></td>
                <td><?php echo stripslashes($rs_rec_c['position']);?></td>
              </tr>
            <?php }
			}
			?></table>
...
<?php						
$res_rec_c=@mysqli_query($con, "select * from hr_app_childtb where appno='$id' order by name");
...
?>
        ...
        <table width="579" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="71"><span class="style12 style13"><strong>To</strong></span></td>
					...
					<?php						
					$res_rec_i=@mysqli_query($con, "select * from hr_app_academic_edutb where appno='$id' order by from_year desc");
  ...
  <tr>
    ...
    <td colspan="3"><fieldset >
      ...
      <table width="579" border="0" align="left" cellpadding="0" cellspacing="0">
        ...
        <?php						
					$res_rec_p=@mysqli_query($con, "select * from hr_app_academic_edutb where appno='$id' order by from_year desc");
					$num = 0;
					?>
        <?php 
        ...
        <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="107"><span class="style12 style13"><strong>Year Obtained</strong></span></td>
		  					...
		  					<?php						
					$res_rec_p=@mysqli_query($con, "select * from hr_app_prof_qualificationtb where appno='$id' order by  to_year desc");
					$num = 0;
					?>
  ...
  <tr>
    ...
    <td colspan="3"><fieldset >
      ...
      <table width="636" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_recognitiontb where appno='$id' order by award_date desc");
  ...
  <tr>
    ...
    <td colspan="3"><fieldset >
      ...
      <table width="641" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_training_apptb where appno='$id' order by end_date desc");
  ...
  <tr>
    ...
    <td colspan="3"><fieldset >
      ...
      <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_prof_membershiptb where appno='$id' order by year_honoured desc");
  ...
  <tr>
    ...
    <td colspan="3"><fieldset >
      ...
      <table width="636" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <?php						
					$res_rec_w=@mysqli_query($con, "select * from hr_app_employmenttb where appno='$id' and employment_type!='Present' order by from_year desc");
  ...
  <tr>
    ...
    <td colspan="3"><fieldset >
      ...
      <table width="652" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_researchtb where appno='$id' order by end_date desc" );
  ...
  <tr>
	...
	<!--Home based publication -->
					...
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'Home Based'  and status = 'In-Print' and type='Journal' " );
...
"; 
        ...
        <td colspan="2">&nbsp;</td>
            ...
            <?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'Home Based'  and status = 'Published' and type='Journal' " );
...
<!--Home based Accepted for publication -->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'Home Based'  and  type='Journal' and status = 'Accepted' " );
...
<!--Home based In-Print Books-->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'Home Based'  and  type='Book' and status = 'In-Print' " );
...
"; 
        ...
        <td colspan="2">&nbsp;</td>
            ...
            <?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'Home Based'  and  type='Book' and status = 'Published' " );
...
<!--Home based Accepted for publication Books-->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'Home Based'  and type='Book' and status = 'Accepted' " );
...
<!--Home based In-Print Chapter in a Book-->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'Home Based'  and  type='Chapter in a Book' and status = 'In-Print' " );
...
"; 
        ...
        <td colspan="2">&nbsp;</td>
            ...
            <?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'Home Based'  and  type='Chapter in a Book' and status = 'Published' " );
...
<!--Home based Accepted for publication Books-->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'Home Based'  and  type='Chapter in a Book' and status = 'Accepted' " );
...
?></td>
        ...
        <td colspan="2">&nbsp;</td>
			...
			<!-- Home Based Edited Conferences -->
				<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'Home Based'  and  type='Edited Conference Proceedings'  " );
...
//											   if(@eregi($sname,$aValue)) $author_str1.="<b> $aValue</b>"; else $author_str.=" $aValue";
	...
	<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'Home Based'  and  type='Technical Report'  " );
...
"; 
	...
	<!--National publication --//////////////////==========================National= -->
	  		  					...
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'National'  and status in ('In-Print','Published') and type='Journal' " );
...
<!--National Accepted for publication -->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'National'  and  type='Journal' and status = 'Accepted' " );
...
<!--National In-Print Books-->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'National'  and  type='Book' and status = 'In-Print' " );
...
"; 
        ...
        <td colspan="2">&nbsp;</td>
            ...
            <?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'National'  and  type='Book' and status = 'Published' " );
...
<!--National Accepted for publication Books-->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'National'  and  type='Book' and status = 'Accepted' " );
...
<!--National In-Print Chapter in a Book-->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'National'  and  type='Chapter in a Book' and status = 'In-Print' " );
...
"; 
        ...
        <td colspan="2">&nbsp;</td>
            ...
            <?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'National'  and  type='Chapter in a Book' and status = 'Published' " );
...
<!--National Accepted for publication Books-->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'National'  and  type='Chapter in a Book' and status = 'Accepted' " );
...
?></td>
        ...
        <td colspan="2">&nbsp;</td>
			...
			<!--National Edited Conferences -->
				<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'National'  and  type='Edited Conference Proceedings'  " );
...
"; 
			...
			<!--National Technical Reports -->
				<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'National'  and  type='Technical Report'  " );
...
End of -->
	...
	<!--International publication --//////////////////=========================== -->
	  		  					...
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'International'  and status = 'In-Print' and type='Journal' " );
...
"; 
        ...
        <td colspan="2">&nbsp;</td>
            ...
            <?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'International'  and status = 'Published' and type='Journal' " );
...
<!--International Accepted for publication -->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'International'  and  type='Journal' and status = 'Accepted' " );
...
<!--International In-Print Books-->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'International'  and  type='Book' and status = 'In-Print' " );
...
"; 
        ...
        <td colspan="2">&nbsp;</td>
            ...
            <?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'International'  and  type='Book' and status = 'Published' " );
...
<!--International Accepted for publication Books-->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'International'  and  type='Book' and status = 'Accepted' " );
...
<!--International In-Print Chapter in a Book-->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'International'  and  type='Chapter in a Book' and status = 'In-Print' " );
...
<!--International Accepted for publication Books-->
	  		  					<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'International'  and  type='Chapter in a Book' and status = 'Accepted' " );
...
<!--Edited Conference International-->
	<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'International'  and  type='Edited Conference Proceedings'  " );
...
<!--Edited Conference International End-->
	...
	<?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_publicationtb where appno='$id'  and category = 'International'  and  type='Technical Report'  " );
...
"; 
  ...
  <tr>
    ...
    <td colspan="3"><fieldset >
      ...
      <table width="644" border="0" align="center" cellpadding="0" cellspacing="0">
        <?php						
					$res_rec_s=@mysqli_query($con, "select * from hr_app_servicetb where appno='$id' and service_type = 'Administrative' order by from_year desc ");
  ...
  <tr>
    ...
    <td colspan="3" rowspan="2"><fieldset >
      ...
      <table width="642" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <?php						
					$res_rec_p1=@mysqli_query($con, "select * from hr_app_servicetb where appno='$id' and service_type != 'Administrative'  order by from_year desc"  );
  ...
  <tr>
    ...
    <table width="648" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <?php						
					$res_rec_e=@mysqli_query($con, "select * from hr_app_employmenttb where appno='$id' and employment_type='Present'");
  ...
  <tr>
    ...
    <table width="558" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
	        <?php						
					$res_rec_r=@mysqli_query($con, "select * from hr_app_refereetb where appno='$id' order by ref_name limit 0,3");
  ...
  <tr>
    <td colspan="5">
        <fieldset>
          <legend><strong>Uploaded Documents</strong></legend>
          <table width="90%" border="0" align="center">
            <tr>
              <td width="5%"><strong>&nbsp;</strong></td>
              <td width="27%"><strong>Document Type</strong></td>
              <td width="20%"><strong>Uploaded Date</strong></td>
              <td width="15%"><strong>Action</strong></td>
              </tr>
           <?php 
		     $res_r=@mysqli_query($con, "select * from hr_app_documenttb where appno='$id' order by id");
			 $sn=0;
		   ...
		   ?>
            <tr>
              <td><?php echo $sn; ?></td>
              <td><?php echo $rs_r['doc_type'];?>&nbsp;</td>
              <td><?php echo date('jS F, o',strtotime($rs_r['added_date']));?>&nbsp;</td>
              <td><?php echo "<a href='{$rs_r['doc_path']}' target='_blank'>VIEW</a>"; ?> </td>
              </tr>
            <?php } //end of while ?>
          </table>
          </fieldset>
