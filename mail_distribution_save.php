...
if(!isset($_SESSION['userLogin']) and !isset($_SESSION['login_id']) and !isset($_SESSION['login_status']) and !isset($_SESSION['role']) and $_SESSION['userLogin']!='ok')
 ...
 if($login_status=='staff')
			...
			//echo $role."=$login_id=>$login_status<br>123";
				$res_r=@mysqli_query($con, "select * from users_roletb where fileno='$login_id' and status='Active' and role like '%Expenditure Control%' ") or die ( mysqli_error($con));
...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <div id="tooplate_content">
        	...
        	<div class="content_box">
                ...
                multipleSelect:true,
                url: 'scriptfile_y.php?contentvar=assign_memo&dept_unit=<?php echo $role_use;?>',
    ...
    <form id= 'assignmails'  enctype="multipart/form-data" name="assignmails"> 
				...
				Staff List:<select name="staff" id="staff" style="width: 350px" >
							<option value="" selected>Select Staff...</option>
							 <?php  $res_s=@mysqli_query($con, "select * from stafftb where dept_code='126' order by surname,fileno");
							 
							  while($rs_s= mysqli_fetch_array($res_s, 3 )){
	   ...
	   echo "<option value='$fileno'>$fullname</option>";
							  ...
							  ?>
						</select><a href="#" class="easyui-linkbutton" iconCls="icon-ok" onClick= "getSelections(); swapcontent('assignmail',$('#memoid').val(),$('#login_id').val()); reloadgrid();">Send</a>
    ...
    <div id="toolbar"><!-- toolbar:'#toolbar', -->
                  ...
                  <?php  //if ($role_use == 'Budget and Expenditure') { ?>
                    <div title="<span class='tt-inner'><img src='images/outmail.png'/><br>Sent Mail</span>" style="padding:10px" >
                    <table id="dgout" title="" style="width:680px;" data-options="
                multipleSelect:true,
                url: 'scriptfile_y.php?contentvar=assign_memo2&dept_unit=<?php echo $role_use;?>',
        ...
        <thead>
            ...
            <th  field="ck" checkbox="true"></th>
                ...
                <th data-options="field:'amount',width:100,align:'left'">AMOUNT</th>
                <th data-options="field:'datein',width:80">DATE</th>
                <th data-options="field:'surname',width:80">SURNAME</th>
                <th data-options="field:'fileno',width:80">FILENO</th>
    ...
    <form id= 'raise_vou'  enctype="multipart/form-data" name="raise_vou"> 
				...
				<a href="#" class="easyui-linkbutton" iconCls="icon-ok"  onClick= "getSelectionss(); swapcontent('raise_v',$('#tmemoid').val(),$('#login_id').val()),reloadgrid();">Unassign Memo </a> 
