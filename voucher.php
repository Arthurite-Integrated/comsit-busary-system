 ...
 //alert(cv+" "+v+" "+a); exit;
  	// var mydata=JSON.stringify($('#dept_frm').serializeObject()); //get all the serialize object as JSON object and decode it where you need them
			...
			if(v=='save')
			 ...
			 if(v=='save') $("#display2").html('<img src="images/loader.gif" width="100" height="100" alt="loading">');
...
<?php
			...
			<select name="voucher_unit" id="voucher_unit" style="width: 300px" onchange="swapcontent('refresh',this.value);">
              ...
              <br />	            <input type="date" name="pay_date" style="width: 300px" id="pay_date" onchange="swapcontent('generate_pvno',this.value);"/></th></tr>
		    <tr>
...
<span id="generate_pvno"><input name="pvno" type="text" style="width: 300px" id="pvno" size="25" /></span></th>
	        ...
	        <input type="hidden" name="ispa" value="No" id="ispa">
		    <!--<tr>
		    ...
		    <tr bgcolor="#6BF4C7">
		      <th height="50" colspan="3" align="center" valign="middle">              	<script>
	...
	//FILTER/SEARCH SCRIPT STAR5T HERE FOR GRIDS
        $(function(){
		    ...
		    <tr bgcolor="#6BF4C7">
		      <th height="20" colspan="3" align="center" valign="middle"></th>
	        </tr>
		    <tr>
	...
	//FILTER/SEARCH SCRIPT STAR5T HERE FOR GRIDS
        $(function(){
		    ...
		    <tr>
		      <th height="50" align="left" valign="middle" bgcolor="#F1F1F1">Account Number<br />		        
		      <input style='width:300px' name="act_no" type="text" id="act_no" size="40" maxlength="20" required /></th>
...
<tr><th colspan="3">
				<input type="button" class="btn" name="sbtn" id="sbtn" value="Save" onclick="swapcontent('voucher_section_entry', 'save'); " />
				<input type="button" class="btn" name="chbtn" id="chsbtn" value="Refresh" onclick="swapcontent('voucher_section_entry', 'refresh'); " />
