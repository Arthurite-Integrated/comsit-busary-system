...
<th colspan='1'>Starting Date<br /><input type="text" name="from" id="from" size="25" tabindex="3" class="easyui-datebox" />
                ...
                <tr>
			  <th colspan='1'>Type Folio Code</th>
			  <th><input name="folio_code" type="text" style="width: 300px" id="folio_code" size="25" /></th>
			  </tr>
	...
	<?php }elseif ($report_type=='Cashbook NCOA'){ ?>
		...
		<input type='radio' name='v_opt' id='v_opt6' tabindex="14" value='trialbalance' checked>Trial Balance<br />
		...
		<?php }elseif ($report_type=='Individual Ledger'){ ?>
		<input type='radio' name='v_opt' id='v_opt6' tabindex="14" value='ledger3' checked>Individual Ledger Search<br />
